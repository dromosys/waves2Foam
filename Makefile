...
build: init
	...
	sed -i 's|export WAVES_APPBIN=\$$FOAM_USER_APPBIN|export WAVES_APPBIN=/home/openfoam/platforms/linux64GccDPOpt/bin|' bin/bashrc.org
	sed -i 's|export WAVES_LIBBIN=\$$FOAM_USER_LIBBIN|export WAVES_LIBBIN=/home/openfoam/platforms/linux64GccDPOpt/lib|' bin/bashrc.org
	./Allwmake